...
.action
{
    background-image: url(../html/images/home/tour-bg.png);
...
.allies-slider.owl-carousel .owl-item img
{
    width: auto;
}
...
.post-bottom.overflow.col-xs-12
{
    margin-top: 0;
    margin-bottom: 20px;
    margin-left: 0;
...
.single-features .col-sm-6.news-text-index
{
    margin-top: 50px;
}
...
.states.caracas.first
{
    top: 120px;
    left: 400px;
}
.states.caracas.second
{
    top: 235px;
    left: 275px;
}
...
.responseAjax, .response-danger
{
    display: none;
}
.responseAjax.active, .response-danger.active
{
    display: block;
}
...
@media(max-width: 990px){
    ...
    .localization-panel > .panel-default > .panel-heading
    {
        background-color: #AFCB08;
...
.portfolio-album .portfolio-view
{
    display: block;
    position: relative;
    height: 300px;
...
.portfolio-album .portfolio-view.album
{
    cursor: pointer;
}
.portfolio-album .portfolio-view .nav-pills li
{
    float: none;
    display: block;
    text-align: center;
}
.portfolio-album .portfolio-view .nav-pills li a
{
    margin: 0 auto;
}
.portfolio-album .portfolio-view .nav-pills li h2
{
    font-size: 28px;
    color: #c0c0c0;
    font-weight: bold;
...
.navbar-menu
{
    ...
    -webkit-animation: slide-navigation 20s linear infinite;
       -moz-animation: slide-navigation 20s linear infinite;
        -ms-animation: slide-navigation 20s linear infinite;
         -o-animation: slide-navigation 20s linear infinite;
            animation: slide-navigation 20s linear infinite;
}
.navbar-menu:hover
{
    background-position: 655px 100%;
}
@-webkit-keyframes slide-navigation {
     0% { 
        background-position: 0 100%;
     } 
     100% {
...
.news-slider .post-content .col-md-6
{
    display: table-cell;
    float: none;
    vertical-align: middle;
...
.news-slider .single-features:last-child
{
    padding-bottom: 0;
}
...
.main-slider-news, .miniImg
{
    position: relative
}
.main-slider-news img, .miniImg img
{
    position: absolute;
    top: 50%;
    left: 50%;
...
.boletin p, .boletin h1, .boletin h2, .boletin h3, .boletin h4, .boletin h5, .boletin h6
{
...
.boletin .bg .content .boletin-title
{
    color: white;
    font-size: 32px;
    font-weight: bold;
}
.boletin .bg-blue .content .boletin-title
{
    font-size: 38px;
}
.bg-blue
