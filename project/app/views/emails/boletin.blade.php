                              ...
                              <table
                                ...
                                <tr>
                                  <td
                                    ...
                                    <!--[if mso | IE]>
                                    <table
                                      align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 1px #333;font-size:1;margin:0px auto;width:600px;" role="presentation" width="600px"
                                      >
                                      <tr>
                          ...
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td
                                ...
                                <div
                                  class="mj-column-px-300 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;"
                                  >
                                  ...
                                  <table
                                          ...
                                          <tbody>
                                            <tr>
                                              <td  style="width:250px;">
                                                @if(count($article[$i]->imagenes) > 0)
                                                  <img
                                                  height="auto" src="{{ asset('images/news/'.$article[$i]->imagenes->first()->image) }}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"
                                                  />
                                                @else
                                                  <img
                                                  height="auto" src="http://via.placeholder.com/600x200" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"
                                                  />
                                                @endif
                                    ...
                                    <tr>
                                      <td
                                        ...
                                        <div
                                          style="font-family:Helvetica Neue;font-size:20px;line-height:1;text-align:left;color:#000000;min-height:100px;"
                                          >
                                          {{ $article[$i]->titles->first()->text }}
                                        </div>
                                      ...
                                      <td
                                        ...
                                        <table
                                          ...
                                          <tbody>
                                            <tr>
                                              <td  style="width:250px;">
                                                @if(count($article[$i+1]->imagenes) > 0)
                                                  <img
                                                  height="auto" src="{{ asset('images/news/'.$article[$i+1]->imagenes->first()->image) }}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"
                                                  />
                                                @else
                                                  <img
                                                  height="auto" src="http://via.placeholder.com/600x200" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"
                              ...
                              <td
                                ...
                                <div
                                  class="mj-column-px-600 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;"
                                  >
                    ...
                    <td
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td
                            style="vertical-align:bottom;width:290px;"
                            >
                            <![endif]-->
                    ...
                    <td
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td
                            style="vertical-align:bottom;width:580px;"
                            >
                            <![endif]-->
