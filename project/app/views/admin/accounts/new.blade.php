...
<div class="container">
    ...
    @if(count($errors->getMessageBag()) > 0)
      ...
      @endif
		<form class="" method="POST" action="{{ URL::to('administrador/nuevo-cuenta/enviar') }}" enctype="multipart/form-data">
      <div class="row">
        <div class="col-sm-12">
      ...
      <div class="row formulario">
        <div class="col-sm-12">
          ...
          <input type="text" name="bank" value="{{ Input::old('bank') }}" class="form-control">
        </div>
      </div>
      <div class="row formulario">
        <div class="col-sm-12">
          <label>Rasón social</label>
          <input type="text" name="social_name" value="{{ Input::old('social_name') }}" class="form-control">
        </div>
      </div>
      <div class="row formulario">
        <div class="col-sm-12">
          <label>Rif</label>
          <input type="text" name="rif" value="{{ Input::old('rif') }}" class="form-control">
        </div>
      </div>
      <div class="row formulario">
        <div class="col-sm-12">
