...
<div class="container">
    ...
    @endif
		<form class="" method="POST" action="{{ URL::to('administrador/modificar-categoria/'.$cat->id.'/enviar') }}" enctype="multipart/form-data">
      <div class="col-xs-12 input-group no-padding">
        <div class="formulario col-xs-12 col-md-6">
          ...
          <input type="text" name="title" class="form-control" placeholder="Titulo" required value="{{ $cat->title }}">
          @if($errors->has('title'))
